...
namespace CompanyProjectWPF.Controls
{
    internal class WatermarkAdorner : Adorner
    {
            ...
            base(adornedElement)
        {
            ...
            this._contentPresenter.Content = watermark;
            this._contentPresenter.Opacity = 0.5;
            this._contentPresenter.Margin = new Thickness(Control.Margin.Left + Control.Padding.Left, Control.Margin.Top + Control.Padding.Top, 0, 0);
